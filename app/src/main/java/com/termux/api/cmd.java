...
import com.termux.api.apis.test;
...
// public class Cmd { 
public class cmd extends TermuxApiReceiver { 
...
Intent parseArg(String[] a) {
	// String action = "Brightness";
	// String method = "Brightness";
	// String method = "Volume";
	String method = "test";
	...
	intent.putExtra("socket_input", "abc");
	intent.putExtra("socket_output", "abc");
	intent.putExtra("api_method", method);
	return intent;
}
